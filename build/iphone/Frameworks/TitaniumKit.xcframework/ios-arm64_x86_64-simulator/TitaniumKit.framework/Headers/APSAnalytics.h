 ...
 * to send analytic data that can be viewed on the HelloWorldApp Dashboard.
 *
 * For information on getting started with HelloWorldApp Platform Services,
 * see [HelloWorldApp Platform Services for iOS](http://bit.ly/1kqteQS).
 */
