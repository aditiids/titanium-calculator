...
/**
 Base class for all HelloWorldApp views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the HelloWorldApp view hierarchy (such as wrapped iOS UIViews) was touched.
