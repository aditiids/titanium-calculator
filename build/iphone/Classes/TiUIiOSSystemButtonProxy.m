...
MAKE_SYSTEM_PROP(ACTIVITY, UIHelloWorldAppNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER, UIHelloWorldAppNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT, UIHelloWorldAppNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK, UIHelloWorldAppNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE, UIHelloWorldAppNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD, UIHelloWorldAppNativeItemContactAdd);
