...
#pragma mark HelloWorldApp Proxy components
...
- (void)userActivityWillSave:(NSUserActivity *)userActivity
{
  if ([self _hasListeners:@"useractivitywillsave"]) {
    DebugLog(@"[WARN] HelloWorldApp.App.iOS.UserActivity.useractivitywillsave event is deprecated. Update user activity and then set HelloWorldApp.App.iOS.UserActivity.needsSave property to true if you need it to be saved before handing it off to another device.");
